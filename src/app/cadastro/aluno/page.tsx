          ...
          {step === 0 && (
            <div className="space-y-5 animate-in fade-in duration-300">
              ...
              <a
                ...
                className="flex items-center justify-center gap-3 w-full py-3 px-4 bg-white text-gray-700 font-semibold rounded-lg hover:bg-gray-100 transition-colors border border-gray-200"
              >
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-zinc-500 text-sm">ou preencha o formulário</span>
                <div className="flex-1 h-px bg-zinc-700" />
              </div>
