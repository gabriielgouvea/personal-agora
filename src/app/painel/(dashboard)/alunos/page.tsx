  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-zinc-500 text-sm mt-1">{total} alunos cadastrados</p>
      </div>
                ...
                <div className="p-5 space-y-4">
                  ...
                  {editing ? (
                    <div className="space-y-3">
                      {(["nome", "sobrenome", "email", "telefone", "cpf", "dataNascimento", "cep", "cidade", "bairro"] as const).map((field) => (
                        <div key={field}>
                    ...
                    <>
                      <div className="grid grid-cols-2 gap-3 text-sm">
                        ...
                        <div>
                          <p className="text-zinc-500 text-xs">CEP</p>
                          <p>{detail.cep || "—"}</p>
                        </div>
                        <div>
                          <p className="text-zinc-500 text-xs">Cadastrado em</p>
                          <p>{new Date(detail.createdAt).toLocaleDateString("pt-BR")}</p>
                        </div>
                      </div>
